...
procedure	apellido_nombre (A:alumnos; D:datos; var apellido_1:string; var nombre_1:string; var apellido_2:string; var nombre_2:string);
...
BEGIN
	...
	apellido_nombre (A,D,apellido_1,nombre_1,apellido_2,nombre_2);
	writeln ('El porcentaje de alumnos con DNI compuesto solo por numeros pares es: ',porcentaje_total:0:2);
	writeln ('El apellido de los dos alumnos de mayor edad es xdddddddtrolld: ', apellido_1,' ',nombre_1, ' y ', apellido_2, ' ', nombre_2);
end.
