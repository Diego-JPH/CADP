...
procedure esc_max (a:integer; n:string; var max_1:integer; var max_2:integer; var nom_1:string; nom_2:string);
begin
...
begin
	...
	if (l = 'Daireaux') then begin
		while (c > 0) and (l = 'Daireaux') do begin
...
BEGIN
	l_max:= p.localidad;
	cant:= 1; max_1:= -1; max_2:= -1; total_esc:= 0;
	leer (p);
